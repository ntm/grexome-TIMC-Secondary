...
my @newOrder = qw(POSITION REF ALT SYMBOL KNOWN_CANDIDATE_GENE Gene Feature CANONICAL BIOTYPE COUNT_HR COUNT_COHORT_HV COUNT_COHORT_HET COUNT_COHORT_OTHERCAUSE_HV COUNT_COHORT_OTHERCAUSE_HET COUNT_COMPAT_HV COUNT_COMPAT_HET COUNT_NEGCTRL_HV COUNT_NEGCTRL_HET COUNT_OTHERGENO IMPACT Consequence HGVSc HGVSp cDNA_position CDS_position Protein_position gnomADe_AF gnomADg_AF AF ALFA_Total_AF ALFA_Total_AC ALFA_Total_AN COHORT_HV COHORT_HET COHORT_OTHERCAUSE_HV COHORT_OTHERCAUSE_HET COMPAT_HV COMPAT_HET);
